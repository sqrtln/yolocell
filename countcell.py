...
def count_cell(image_path):
    opt = parse_opt()
    opt.source = image_path
    check_requirements(ROOT / 'requirements.txt', exclude=('tensorboard', 'thop'))
    cell_number = run(**vars(opt))
    return cell_number
# cell_number = count_cell("./BloodImage_00224.jpg")
# cell_number = count_cell("./BloodImage_00402.jpg")
cell_number = count_cell("./BloodImage_00357.jpg")
print(cell_number)
